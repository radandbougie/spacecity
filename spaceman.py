"""Spaceman
 A word is chosen at random from a list of words and people relating to Houston, Texas and the
user must guess the word letter by letter before running out of attempts."""

import random

def main():
    welcome = ['Welcome to Spaceman! A word relating to Houston, Texas will be chosen at random and',
    ...
    while play_again:
        ...
        words = ["rockets", "astros", "travis scott", "screw", "beyonce",
                 "third ward", "hurricane", "whataburger", "pimp c", "tejano",
                 "astro world", "nasa", "galveston", "texans", "comet",
                 "minute maid", "astrodome", "rodeo", "funplex", "h town"
                 ]
...
""")
        ...
        if "-" not in word_guessed: # no blanks remaining
            ...
            print(("\nDude WTF! The word was {}.").format(chosen_word))
